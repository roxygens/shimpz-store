...
COPY backend/app/__init__.py backend/app/assistant_releases.py backend/app/config.py backend/app/logconf.py backend/app/main.py backend/app/model_catalog.json backend/app/team_driver_contract.py \
