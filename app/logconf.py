...
print(), never the stdlib logging module directly — the shimpz-stdcheck gate BLOCKs both. LOG_FORMAT=console
...
def setup(service: str) -> None:
    ...
    if os.getenv("LOG_FORMAT", "json") == "console":
        ...
        processors = [*shared, structlog.processors.EventRenamer("msg"), structlog.processors.JSONRenderer()]
    structlog.configure(
