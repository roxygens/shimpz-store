...
const D: Dict = {
  ...
  brain_switch_hint: {
    en: "Provider and model changes apply to future turns without recreating the Capsule or its Assistants.",
    pt: "Alterações de provedor e modelo valem nos próximos turnos sem recriar a Cápsula ou seus Assistants.",
  },
  ...
  model_hint: {
    en: "Stored as Capsule configuration; it does not recreate or restart the Capsule.",
    pt: "Salvo como configuração da Cápsula; não recria nem reinicia a Cápsula.",
  },
  brain_wait: {
